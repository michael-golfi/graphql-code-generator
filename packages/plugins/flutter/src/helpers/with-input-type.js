...
export default function withInputType(baseType, replaceMap, className, exclusionConfig) {
  if (
    exclusionConfig &&
    (!shouldBeIncluded(className, exclusionConfig) || shouldExcludeOnType(baseType, exclusionConfig))
  ) {
    return [];
  }
